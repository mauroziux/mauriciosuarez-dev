...
screenshots:
  ...
  - src: "/projects/mantto/ai-flow.svg"
    alt: "Mantto flow diagram: field inspection, AI proposing findings as draft, human review of evidence and state, approved maintenance with evidence, and slow work in the background"
    caption: "AI proposes; review and state belong to the application. Documented reconstruction."
